...
import 'package:flash_clean/pages/store/store.page.dart';
import 'package:flash_clean/pages/login/login.page.dart';
import 'package:flash_clean/pages/home/home.binding.dart';

final routes = [
  GetPage(name: '/', page: () => InitPage()),
  GetPage(name: '/login', page: () => LoginPage()),
  GetPage(name: '/home', page: () => HomePage(), binding: HomeBinding()),
  GetPage(name: '/store', page: () => StorePage(), binding: HomeBinding()),
